...
def generate_oltp(n=1000000):
    ...
    for i in range(n):
        ...
        bought = random_date(datetime(2024, 1, 1), datetime(2024, 6, 1))
        ...
        transaction = {
            ...
            'qty': qty,
            'channel_id': f'CH{choice([i["channel_id"] for i in CHANNELS])}',
...
def generate_csv(n=50000):
    ...
    for i in range(n):
        product = choice(PRODUCTS)
        qty = randrange(1, 7)
        boughtdate = str(random_date(datetime(2024, 1, 1), datetime(2024, 6, 1)))
        first_name = choice(FIRST_NAMES)
        last_name = choice(LAST_NAMES)
        ...
        transaction = {
            ...
            'Sales Channel': f'{choice(get_channel_distribution("reseller"))}',
...
def insert_csv():
    ...
    for resellerid in CSV_RESELLERS:
        ...
        for day in ALL_DAYS:
            ...
            with open(f"/home/generator/csv/raw/DailySales_{new_format}_{resellerid}.csv", 'w', newline='') as output_file:
...
def generate_xml(resellerid, n=50000):
    ...
    for i in range(n):
        ...
        transaction = {
            ...
            'salesChannel': f'{choice(get_channel_distribution("reseller"))}',  # Ensure channel_id starts with 'CH'
...
def insert_xml():
    ...
    for resellerid in XML_RESELLERS:
        ...
        for day in ALL_DAYS:
            ...
            with open(f"/home/generator/xml/raw/rawDailySales_{new_format}_{resellerid}.xml", 'w') as output_file:
                output_file.write('\n'.join(result))
...
cleanup('/home/generator/xml/raw', 'xml')
cleanup('/home/generator/xml/processed', 'json')
